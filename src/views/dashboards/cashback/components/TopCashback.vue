    ...
    <b-card no-body>
      <b-card-header>
        <b-row class="align-items-center">
          <div class="col">
            <b-card-title>Cashbacks por lojas</b-card-title>
          </div>
        </b-row>
      </b-card-header>
            ...
            <b-tr v-for="(item, idx) in items" :key="idx">
                  ...
                  <div class="flex-grow-1 text-truncate">
                    ...
                    <div class="d-flex align-items-center">
                      <div
                        ...
                        :aria-valuenow="item.percent_cashback"
                        aria-valuemin="0"
                        aria-valuemax="100"
                      >
                        <div
                          class="progress-bar bg-primary"
                          :style="`width: ${item.percent_cashback}%`"
                        ></div>
                      </div>
                      <small class="flex-shrink-1 ms-1"
                        >{{ item.percent_cashback }}%</small
                      >
                    </div>
                  </div>
                </div>
              ...
              <b-td class="px-0 text-end"
                ><span class="text-body ps-2 align-self-center text-end"
                  >{{ formatData.formatNumberToFloat(item.total_cashback) }}</span
                >
              </b-td>
            </b-tr>
          </b-tbody>
